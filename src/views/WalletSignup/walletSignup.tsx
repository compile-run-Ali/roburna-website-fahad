...
const options = [
  {
    label: "Store and trade cryptocurrencies",
    value: "Store and trade cryptocurrencies",
  },
...
const options2 = [
  ...
  {
    label: "A hardware (cold storage) wallet",
    value: "A hardware (cold storage) wallet",
  },
...
export function WalletSignup() {
  ...
  const onChange = (value: string, name: string, type: string) => {
    const { newValue, newErrors } = validate(
      listData,
      validationErrors,
      value,
      name,
  ...
  const mandatoryErrors = useMemo(() => {
    ...
    if (isEmpty(listData.relationship_with_roburna))
      _errors.relationship_with_roburna = "select any option";
    if (isEmpty(listData.plan_to_use_roburna_wallet))
      _errors.plan_to_use_roburna_wallet = "this field required";
  ...
  const errors: { [key: string]: string } = useMemo(() => {
    const _errors = {
      ...(submitClicked ? mandatoryErrors : {}),
      ...validationErrors,
    };
    return _errors;
  }, [submitClicked, mandatoryErrors, validationErrors]);
  const valid = useMemo(
    () => isEmpty(errors) && isEmpty(mandatoryErrors),
  ...
  const onSubmit = async (
    ...
    if (valid) {
      const status = await postwalletWaiting({
        ...listData,
        crypto_wallet: cryptowallet.join(", "),
        primarily_using_wallet: primarywallet.join(", "),
      });
      if (status) {
      ...
      <section className="align-items-center position-relative wallet-signup-background">
        <div className="arbor-banner-content2">
          <div className="arbor-banner-text-content2">
            <h2 className="mb-5">
              Sign up for the Roburna Wallet - your safe passage to a greener,
              more inclusive and accessible DeFi.
            </h2>
            <p className="mb-5">
              <br />
              <br />
              ...
              <br />
              <br />
              Our custom Wallet will be launched on roburna mainnet, you can
              sign up fot it now for a chance to get exclusive access at Beta
              launch.
            </p>
            <a
              href="#wallet-signup-form"
              className="--btn-1 custom-button-style"
            >
              SIGN UP FOR THE ROBURNA WALLET
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="col-lg-10 offset-lg-1 arborswap-column2">
          ...
          <section className="arborswap-banner2">
            <div className="d-flex justify-content-center flex-column arborswap-banner-box mt-5">
              <div className="banner-text-box text-center d-flex flex-column align-items-center justify-content-center mt-md-0">
                <h2>
                  SIGN UP<span> TO GET EXCLUSIVE ACCESS</span>
                </h2>
                <h5>
                  Fill out the sign-up form for a chance to get exclusive access
                  at Beta launch!
                </h5>
                <p>
          ...
          <section>
            <div id="wallet-signup-form" className="arbor-form-box2">
              <form className="row">
                <div className="gender-radio">
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      id="inlineRadio2"
                      onChange={(e) =>
                        setListData({ ...listData, gender: "Mr" })
                      }
                    />
                    <label className="form-check-label" htmlFor="inlineRadio1">
                      Mr
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      id="inlineRadio2"
                      onChange={(e) =>
                        setListData({ ...listData, gender: "Ms" })
                      }
                    />
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      id="inlineRadio2"
                      onChange={(e) =>
                        setListData({ ...listData, gender: "Mx" })
                      }
                    />
                    <label className="form-check-label" htmlFor="inlineRadio2">
                      Mx
                ...
                <div className="col-lg-6">
                  <input
                    ...
                    name="name"
                    className={`${
                      !isEmpty(errors.name) ? "validationError" : ""
                    } `}
                    value={listData.name || ""}
                    placeholder="Name*"
                  ...
                  <input
                    ...
                    name="Email"
                    className={`${
                      !isEmpty(errors.email) ? "validationError" : ""
                    } `}
                  ...
                  <div className="row">
                    <div className="col-lg-8">
                      <div className="select-wrap">
                        <select
                          className={`${
                            !isEmpty(errors.country) ? "validationError" : ""
                          }
                                                    ${
                                                      listData.country
                                                        ? "selected"
                    ...
                    <div className="col-lg-4">
                      <div className="select-wrap">
                        <select
                          defaultValue={"Age"}
                          className={`${
                            !isEmpty(errors.age) ? "validationError" : ""
                          }
                                                    ${
                                                      listData.age
                                                        ? "selected"
                          ...
                          onChange={(e) =>
                            setListData({ ...listData, age: e.target.value })
                          }
                          value={listData.age}
                        >
                  ...
                  <div className={`select-wrap`}>
                    <select
                      defaultValue={
                        "Income range, compared to your country of residence (optional)"
                      }
                      className={`${
                        !isEmpty(errors.income_range) ? "validationError" : ""
                    ...
                    >
                      <option hidden>
                        Income range, compared to your country of residence
                        (optional)
                      </option>
                      ...
                      <option value="I could buy my country">
                        I could buy my country
                      </option>
                    </select>
                  </div>
                ...
                <div className="col-lg-6">
                  <div className="select-wrap">
                    <select
                      ...
                      className={`${
                        !isEmpty(errors.relationship_with_roburna)
                          ? "validationError"
                          : ""
                      } `}
                      onChange={(e) =>
                    ...
                    >
                      ...
                      <option value="Just found out about it">
                        Just found out about it
                      </option>
                      <option value="Interested, but not invested">
                  ...
                  <input
                    ...
                    className={`${
                      !isEmpty(errors.plan_to_use_roburna_wallet)
                        ? "validationError"
                        : ""
                    } `}
                  ...
                  <textarea
                    name="message"
                    className={`${
                      !isEmpty(errors.message) ? "validationError" : ""
                    } custom-textarea`}
                    onChange={(e) =>
                      onChange(e.target.value, "message", "string")
                    }
                  ...
                  <div>
                    ...
                    <div className="form-check">
                      ...
                      />
                      <label
                        className="form-check-label custom-label-style"
                        htmlFor="defaultCheck2"
                      >
                        Allow Roburna to use my data for personalized
                        communication (not to be shared with third parties)
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <button
                className="--btn-1 custom-button-style mt-5"
                onClick={onSubmit}
              >
                Sign Up
              </button>
