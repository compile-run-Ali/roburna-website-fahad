...
export function Blogpost() {
  ...
  return (
    <div className="blog-page">
      ...
      {blog && (
        <>
          <section className="Main-blog-Top">
            <h1 className="special-heading blog-heading">BLOG</h1>
              ...
              <div className="col-lg-6 px-0">
                <div className="latest-blog-content p-md-5 p-3 h-100">
                  ...
                  <div className="tag-time">
                    {blog.tag}| {formatDateTime(blog.created_at)}
                  </div>
                  <h2 className="px-lg-5 my-md-5 my-3">{blog.title}</h2>
                  <p className="mb-md-5 px-lg-5">{blog.short_description}</p>
                </div>
              </div>
      ...
      <div className="p-md-0 mt-md-5 mt-3 p-4 text-center">
        <a href="#blogdesc" className="blogpost-scroll">
          <img src={chev} />
        </a>
      </div>
      {blog && (
        <>
          <section
            id="blogdesc"
            className="blogpost-main-sec d-flex flex-column"
          >
            <div
